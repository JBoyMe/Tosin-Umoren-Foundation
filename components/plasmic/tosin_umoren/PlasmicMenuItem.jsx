...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: PQPet58IvEDP/css
...
function PlasmicMenuItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eh0O2)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wg8Vu)}>
            <div
              className={classNames(
                projectcss.all,
