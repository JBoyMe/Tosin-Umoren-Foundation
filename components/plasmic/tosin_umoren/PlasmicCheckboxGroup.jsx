...
import Checkbox from "../../Checkbox"; // plasmic-import: MI4geyTo9Q6x/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: uUtDfd6ckQbN/css
...
function PlasmicCheckboxGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__d1Msw)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___7QFxm)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__h1XRf)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__iwbIe)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
