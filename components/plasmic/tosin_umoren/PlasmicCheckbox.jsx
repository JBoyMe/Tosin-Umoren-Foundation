...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: MI4geyTo9Q6x/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: uKLUH9Scq81q/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: JPMZrv-DHywu/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__je9Nx)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__iFaKi)}
            role={"img"}
          />
        ) : null}
      </div>
