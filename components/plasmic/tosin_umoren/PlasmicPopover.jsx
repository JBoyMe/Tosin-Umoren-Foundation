...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: Gmt57k2iIFO8/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: JNS54BLyiWo6/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__oVwOb)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___2XWo)}
            label={"Open Popover"}
          />
        ),
