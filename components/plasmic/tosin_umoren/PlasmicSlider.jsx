...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: CZIY0dy1P4om/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox___06QX)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ombxD)}>
        <div
