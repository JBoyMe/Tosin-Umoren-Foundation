...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: o5tQ_tQoMIOC/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__nCwys)}>
        <div className={classNames(projectcss.all, sty.freeBox__pyKkZ)} />
      </div>
      {renderPlasmicSlot({
