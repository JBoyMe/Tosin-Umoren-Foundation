...
import TextInput from "../../TextInput"; // plasmic-import: Ivnh3soxAGvf/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: CXdpmDZk7i7H/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: vg5fYXmFXrxx/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mBUu8, {
          [sty.freeBoxiconEnd__mBUu896Usr]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__mBUu8NdNvB]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__mBUu8KAs8U]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__u2UPn, {
            [sty.freeBoxiconStart__u2UPnndNvB]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__u2UPnkAs8U]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__mCx4)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__uDlxv, {
            [sty.freeBoxiconEnd__uDlxv96Usr]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__uDlxVndNvB]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___1G0Zi)}
                role={"img"}
              />
            ),
