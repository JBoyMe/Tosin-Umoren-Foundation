...
import SliderThumb from "../../SliderThumb"; // plasmic-import: sg52LhnH3D_e/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: oe3FYyDyqCXz/css
...
function PlasmicRangeSlider__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zMe3U)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__m3E9B)}>
        <div
