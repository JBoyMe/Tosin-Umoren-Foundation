...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: JG7_jf22p7oS/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__iqSf)}
                    value={"item1"}
                  />
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__zFu)}
                    label={"Item 3"}
                    value={"item3"}
                  />
